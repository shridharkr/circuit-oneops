...
Function Create-Win-User {
  ...
  $user = $ADSIComp.Create('User',$Username)
...
#####################################################
Write-Output “Adding admin user to cygwin ...”

C:\cygwin64\bin\mkpasswd.exe -u admin -l > C:\cygwin64\etc\passwd
...
#C:\cygwin64\bin\cygstart.exe --action=runas C:\cygwin64\bin\chown.exe admin /home/admin
...
Write-Output "admin was created in cygwin"

#####################################################

Write-Output "Adding oneops user to windows ..."
Create-Win-User
Write-Output "'oneops' user added as admin in windows"

######################################################

Write-Output "Adding oneops user to cygwin ..."

C:\cygwin64\bin\mkpasswd.exe -u oneops -l > C:\cygwin64\etc\passwd
C:\cygwin64\bin\mkgroup.exe -l > C:\cygwin64\etc\group
...
#C:\cygwin64\bin\cygstart.exe --action=runas C:\cygwin64\bin\chown.exe oneops /home/oneops
...
Write-Output "'oneops' user added to cygwin "