...
Copy-Item C:\cygwin64\home\admin C:\cygwin64\home\oneops -recurse -force
...
New-Item C:\cygwin64\opt\oneops\workorder\ -ItemType directory

$FilesAndFolders = gci "C:\cygwin64\home\oneops" -recurse | % {$_.FullName}
foreach($FileAndFolder in $FilesAndFolders)
{
    ...
    $permission = "oneops","FullControl","Allow"
