...
my @mess2 = ("is responding | critical_response=0.00; port_open=1.00; ","is slow responding | critical_response=0.00; port_open=1.00; ","is not responding | critical_response=1.00; port_open=0.00; \n","host lookup failed | critical_response=1.00; port_open=0.00; \n");
