...
cmd_str.concat(" &&/#{search_pattern}/ {count++;fcount[FILENAME]=fcount[FILENAME]+1} END {for(var in fcount) print #{ciId},var,\"Matches found=\" fcount[var]; print \"\\n\" #{ciId} ,\"Total Matches=\", count}' #{file_names}")
